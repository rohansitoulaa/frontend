...
const Step5 = ({onFinish}:Step4Props) => {
 const {close} = useModalStore()
  return (
    ...
    <div className='bg-linear-65 from-[#d4e9fa] to-[#a1c6e3] border-black w-100 h-100 rounded-xl items-center text-center flex flex-col  gap-5'>
      ...
      <Button btnTheme='borderBlack' chevronPosition='right' value='View Approval Status'/>
    </div>
    </div>
    </div>
  )
