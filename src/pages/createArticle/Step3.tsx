...
const Step3 = ({ onNext, onBack }: StepProps) => {
  ...
  return (
    <div className="fixed w-full inset-0 z-50 flex items-center justify-center">
      ...
      <div className="flex flex-col justify-center items-center relative z-10 w-full max-w-3xl mx-auto p-6 overflow-y-auto max-h-[90vh] bg-linear-65 from-[#f2f2f2] to-[#b2d1e8] dark:bg-linear-65 dark:from-[#2d2b2b] dark:to-[#171c20] dark:text-[#f2f2f2] shadow-xl rounded-2xl">
        ...
        <div className="mt-4 w-full">
          {!selectedFile ? (
            <div
              ...
              className="flex flex-col items-center justify-center border-2 border-black bg-linear-65 from-[#f2f2f2] to-[#a9bccb] dark:bg-linear-65 dark:from-[#434040] dark:to-[#171c20] dark:text-[#f2f2f2] rounded-lg w-full py-10 text-center cursor-pointer relative"
            >
              <p>Drag and Drop</p>
              <p>or</p>
