...
const Step2 = ({ onNext, onBack }: Step2Props) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start min-h-screen ">
        ...
        <div className="flex flex-col gap-6 items-center w-full md:w-[85%]">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-3">
              ...
              <p className="text-red-500 text-sm min-h-5 ml-7">{formik.errors.termsAgreed}</p>
            <div className="flex gap-3">
              <input
                className="w-4"
                type="checkbox"
      ...
      <section className="w-1/2 md:w-1/2 min-h-full h-screen md:min-h-full  bg-[white] md:w-full flex flex-col  items-center md:mt-0 shadow-2xl">
      <div className="mt-10 flex flex-col gap-5 items-center">

         <img 
         className="rounded-4xl shadow-md w-100"
         src="images/upload_instantly.svg" alt="" />
